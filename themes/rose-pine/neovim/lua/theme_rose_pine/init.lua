-- Auto-generated colorscheme: Rose Pine
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-rose-pine"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_rose_pine.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_rose_pine.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_rose_pine.overrides")
