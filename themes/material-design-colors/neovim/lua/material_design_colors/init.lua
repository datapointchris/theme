-- Auto-generated colorscheme: Material Design Colors
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = 'material-design-colors'
  vim.o.termguicolors = true
  vim.o.background = 'dark'

  local colors = require('material_design_colors.palette')
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ 'editor', 'syntax', 'treesitter', 'lsp', 'plugins' }) do
    local ok, hl_mod = pcall(require, 'material_design_colors.highlights.' .. mod)
    if ok then
