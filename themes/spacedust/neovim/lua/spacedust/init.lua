-- Auto-generated colorscheme: Spacedust
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = 'spacedust'
  vim.o.termguicolors = true
  vim.o.background = 'dark'

  local colors = require('spacedust.palette')
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ 'editor', 'syntax', 'treesitter', 'lsp', 'plugins' }) do
    local ok, hl_mod = pcall(require, 'spacedust.highlights.' .. mod)
    if ok then
