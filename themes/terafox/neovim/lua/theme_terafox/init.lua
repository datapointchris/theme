-- Auto-generated colorscheme: Terafox
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-terafox"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_terafox.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_terafox.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_terafox.overrides")
