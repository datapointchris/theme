...
M.palette = {
  ...
  diagnostic_info = "#96D9F1",
  diagnostic_hint = "#ba8acc",
  syntax_comment = "#8F8F8F",
  syntax_string = "#F6DC69",
  syntax_function = "#96D9F1",
  syntax_keyword = "#D1FA71",
  syntax_type = "#96D9F1",
  syntax_number = "#F6DC69",
  syntax_constant = "#96D9F1",
  syntax_operator = "#f7f7f7",
  syntax_variable = "#f7f7f7",
  syntax_parameter = "#96D9F1",
  syntax_preproc = "#D1FA71",
  syntax_special = "#d7d7d7",
  syntax_punctuation = "#8F8F8F",
  syntax_tag = "#207383",
  syntax_attribute = "#d6837c",
  ui_accent = "#207383",
  ui_border = "#7a7a7a",
  ui_selection = "#207483",
  ui_float_bg = "#2b2b2b",
