-- Auto-generated colorscheme: GitHub Dark Dimmed
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-github-dark-dimmed"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_github_dark_dimmed.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_github_dark_dimmed.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_github_dark_dimmed.overrides")
