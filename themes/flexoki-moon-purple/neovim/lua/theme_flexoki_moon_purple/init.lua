-- Auto-generated colorscheme: Flexoki Moon Purple
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-flexoki-moon-purple"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_flexoki_moon_purple.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_flexoki_moon_purple.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_flexoki_moon_purple.overrides")
