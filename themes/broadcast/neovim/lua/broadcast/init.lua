-- Auto-generated colorscheme: Broadcast
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = 'broadcast'
  vim.o.termguicolors = true
  vim.o.background = 'dark'

  local colors = require('broadcast.palette')
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ 'editor', 'syntax', 'treesitter', 'lsp', 'plugins' }) do
    local ok, hl_mod = pcall(require, 'broadcast.highlights.' .. mod)
    if ok then
