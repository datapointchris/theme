-- Auto-generated colorscheme: Everforest Dark Hard
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-everforest-dark-hard"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_everforest_dark_hard.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_everforest_dark_hard.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_everforest_dark_hard.overrides")
