-- Auto-generated colorscheme: Retro Legends
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = 'retro-legends'
  vim.o.termguicolors = true
  vim.o.background = 'dark'

  local colors = require('retro_legends.palette')
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ 'editor', 'syntax', 'treesitter', 'lsp', 'plugins' }) do
    local ok, hl_mod = pcall(require, 'retro_legends.highlights.' .. mod)
    if ok then
