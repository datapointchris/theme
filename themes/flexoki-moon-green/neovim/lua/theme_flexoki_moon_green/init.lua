-- Auto-generated colorscheme: Flexoki Moon Green
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = "theme-flexoki-moon-green"
  vim.o.termguicolors = true
  vim.o.background = "dark"

  local colors = require("theme_flexoki_moon_green.palette")
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ "editor", "syntax", "treesitter", "lsp", "plugins" }) do
    local ok, hl_mod = pcall(require, "theme_flexoki_moon_green.highlights." .. mod)
    if ok then
  ...
  local ok, overrides = pcall(require, "theme_flexoki_moon_green.overrides")
