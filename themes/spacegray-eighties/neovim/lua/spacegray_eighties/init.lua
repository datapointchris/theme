-- Auto-generated colorscheme: Spacegray Eighties
local M = {}
...
function M.load()
  ...
  vim.g.colors_name = 'spacegray-eighties'
  vim.o.termguicolors = true
  vim.o.background = 'dark'

  local colors = require('spacegray_eighties.palette')
  local highlights = {}

  -- Collect all highlight groups
  for _, mod in ipairs({ 'editor', 'syntax', 'treesitter', 'lsp', 'plugins' }) do
    local ok, hl_mod = pcall(require, 'spacegray_eighties.highlights.' .. mod)
    if ok then
