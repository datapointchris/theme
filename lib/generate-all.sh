#!/usr/bin/env bash
# Generate all app configs for all themes in parallel
#
# Usage: lib/generate-all.sh [--themes <pattern>] [--generators <pattern>]
#
# Examples:
#   lib/generate-all.sh                          # All themes, all generators
#   lib/generate-all.sh --themes "everforest*"   # Only everforest themes
#   lib/generate-all.sh --generators ghostty     # Only ghostty generator
