...
- `neovim-comparison-results.md` - Documented findings (regenerated by the script; conclusions are in Results Summary above)
...
```text
analysis/
├── neovim/experiment-plan.md       # This file
├── experiments/neovim_palette_extractor.py     # Experiment 1
├── experiments/neovim_highlight_extractor.py   # Experiment 2 data prep
├── experiments/neovim_ml_predictor.py          # Experiment 2 ML
├── experiments/neovim_cross_comparison.py      # Experiment 3
├── neovim-comparison-results.md    # Regenerated by experiment 3
└── experiments/neovim_data/
